...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab4/interpolator/interpolator.runs/synth_3'
cd "$HD_PWD"
...
EAStep vivado -log interpolator_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interpolator_top.tcl
