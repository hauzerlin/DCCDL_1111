...
assign add_ff[0] = {{4{buf_ff1[0]}},buf_ff1[0:14]};
assign add_ff[1] = {{4{buf_ff2[0]}},buf_ff2[0:14]};
assign add_ff[2] = {{4{buf_ff3[0]}},buf_ff3[0:14]};
assign add_ff[3] = {{4{buf_ff4[0]}},buf_ff4[0:14]};

add_s4_13 add1( add_ff[0], add_ff[1], next_add[0]);
add_s4_13 add2( next_add[0], add_ff[2], next_add[1]);
add_s4_13 add3( next_add[1], add_ff[3], out);
