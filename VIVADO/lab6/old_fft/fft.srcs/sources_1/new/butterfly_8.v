...
assign L_real_buff = {{1{UI_real[0]}},UI_real} - {{1{LI_real[0]}},LI_real};
assign L_imag_buff = {{1{UI_imag[0]}},UI_imag} - {{1{LI_imag[0]}},LI_imag};
assign U_real_buff = {{1{UI_real[0]}},UI_real} + {{1{LI_real[0]}},LI_real};
assign U_imag_buff = {{1{UI_imag[0]}},UI_imag} + {{1{LI_imag[0]}},LI_imag};
