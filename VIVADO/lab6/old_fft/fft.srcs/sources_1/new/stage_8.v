`timescale 1ns / 1ps
module stage_8(clk, rst, cnt, LI_real, LI_imag, UI_real, UI_imag, LO_real, LO_imag, UO_real, UO_imag);
input clk;
input rst;
//reg [2:0] cnt;
input [2:0] cnt;
...
output wire signed [13:0] LO_real, LO_imag;
output wire signed [13:0] UO_real, UO_imag;
