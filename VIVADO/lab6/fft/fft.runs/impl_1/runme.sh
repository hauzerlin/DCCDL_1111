...
HD_PWD='D:/1111/DCCDL/VIVADO/lab6/fft/fft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stage_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stage_8.tcl -notrace
