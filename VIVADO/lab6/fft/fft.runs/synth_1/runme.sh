...
HD_PWD='D:/1111/DCCDL/VIVADO/lab6/fft/fft.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stage_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stage_8.tcl
