...
assign L_real_buff = {UI_real[10],UI_real} - {LI_real[10],LI_real};
assign L_imag_buff = {UI_imag[10],UI_imag} - {LI_imag[10],LI_imag};
assign U_real_buff = {UI_real[10],UI_real} + {LI_real[10],LI_real};
assign U_imag_buff = {UI_imag[10],UI_imag} + {LI_imag[10],LI_imag};
