...
HD_PWD='D:/1111/DCCDL/VIVADO/lab6/part2/lab/lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft32_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft32_top.tcl -notrace
