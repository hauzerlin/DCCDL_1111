...
HD_PWD='E:/1111/DCCDL/VIVADO/lab6/part2/fft_32points/fft_32points.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft32_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft32_top.tcl
