...
wire signed [11:0]  LO_real, LO_imag, UO_real, UO_imag; // output before ping-pong access
wire signed [11:0] p_real, p_imag;  // output after ping-pong access
wire  signed [11:0] test1, test2, test3, test4, test5, test6;//, test7;//test1, test2, 
