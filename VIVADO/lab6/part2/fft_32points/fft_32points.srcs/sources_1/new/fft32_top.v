...
output  signed [11:0] test1, test2, test3, test4, test5, test6;
output signed[4:0] test7;//test1, test2, 

stage_32 dft32(clk, rst,  LI_real, LI_imag, UI_real, UI_imag, low_real_32_16, low_imag_32_16 ,up_real_32_16, up_imag_32_16,test1, test2,  test3, test4, test5, test6, test7);
...
//        ping_pong_cnt <= 5'b11111; // control signal reset
//        write_en <= 1'b0;
//        read_en <= 1'b0;
        
        LO_real= 12'd0; // output reset
        LO_imag= 12'd0;
        UO_real= 12'd0;
        UO_imag= 12'd0;
        p_real<= 15'd0;
