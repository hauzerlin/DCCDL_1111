`timescale 1ns / 1ps
module stage_32(clk, rst,  LI_real, LI_imag, UI_real, UI_imag, LO_real, LO_imag, UO_real, UO_imag,test1, test2,  test3, test4, test5, test6, cnt);
input clk;
input rst;
...
commutator_32 commutator32(.rst(rst), .control(cnt[4]),
             .LI_real(LI_real), .LI_imag(LI_imag),// .UI_real(UI_real_in), .UI_imag(UI_imag_in), 
...
//        UO_real = UO_real_b_m;
//        UO_imag = UO_imag_b_m;
//        LO_real = LO_real_m_out;
//        LO_imag = LO_imag_m_out;
