...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab5/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arctan_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arctan_top.tcl -notrace
