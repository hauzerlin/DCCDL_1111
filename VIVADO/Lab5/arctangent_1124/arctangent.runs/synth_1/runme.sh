...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab5/arctangent/arctangent.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arctan_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arctan_top.tcl
