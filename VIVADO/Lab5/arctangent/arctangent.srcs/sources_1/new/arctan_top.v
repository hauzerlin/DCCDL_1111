...
module arctan_top(clk, rst, xin, yin,x_init_0, y_init_0, x_0_1, y_0_1, xout, yout, ang_out);
input clk;
input rst;
...
output wire signed [0:14] x_0_1, y_0_1;
...
initial_stage dft1(xin, yin, x_init_0, y_init_0);
arctangent0 dft2( x_init_0, y_init_0, x_0_1, y_0_1, ang_0_1);
arctangent1 dft3( x_01, y_01, ang_01, xout, yout, ang_out);
