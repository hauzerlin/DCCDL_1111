...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab2/serial_comparator2/serial_comparator2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_comparator32.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parallel_comparator32.tcl -notrace
