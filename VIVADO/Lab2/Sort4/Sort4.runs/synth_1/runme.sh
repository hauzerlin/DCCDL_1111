...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab2/Sort4/Sort4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sort4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sort4.tcl
