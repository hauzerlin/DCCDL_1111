...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab2/Sort4/Sort4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sort4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sort4.tcl -notrace
