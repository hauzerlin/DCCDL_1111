...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab2/selectTOP6/selectTOP6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log selectTOP6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source selectTOP6.tcl -notrace
