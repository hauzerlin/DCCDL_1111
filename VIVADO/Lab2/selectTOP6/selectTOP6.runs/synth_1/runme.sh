...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab2/selectTOP6/selectTOP6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selectTOP6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selectTOP6.tcl
