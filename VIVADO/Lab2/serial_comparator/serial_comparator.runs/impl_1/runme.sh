...
HD_PWD='E:/1111/DCCDL/VIVADO/Lab2/serial_comparator/serial_comparator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max_comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max_comparator.tcl -notrace
