...
HD_PWD='E:/1111/DCCDL/VIVADO/Lab2/serial_comparator/serial_comparator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log max_comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source max_comparator.tcl
