...
input signed [0:12] in_value_a; // value a + index 8+5 bits
input signed [0:12] in_value_b; // value b+ index 8+5 bits
output reg  compare_result; // binary 1 or 0
output reg [0:12] out_value; // value+index

always @(in_value_a or in_value_b)
begin
if(in_value_a[0:7]<in_value_b[0:7]) compare_result <= 1;
