...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/transfer_form_fir/transfer_form_fir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transposed_form_fir_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transposed_form_fir_top.tcl
