...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/transfer_form_fir/transfer_form_fir.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log transposed_form_fir_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source transposed_form_fir_top.tcl -notrace
