...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/direct_form_fir/direct_form_fir.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_form_fir_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source direct_form_fir_top.tcl -notrace
