...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/direct_form_fir/direct_form_fir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log direct_form_fir_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source direct_form_fir_top.tcl
