...
module direct_form_fir_top(clk, input_x, output_y, en_x);
    ...
    reg signed [0:19] memory_x [0:31]; // s2.17
    ...
    always @(posedge clk)
        ...
        // 33 multiplers
        s2_17_mult multer1 (	  .s2_17_a(input_x),    .s2_17_b(memory_h[0]),  .s11_18(mult_result[0]));
        s2_17_mult multer2 (  .s2_17_a(memory_x[0]), 	.s2_17_b(memory_h[1]),  .s11_18(mult_result[1]));
        s2_17_mult multer3 (  .s2_17_a(memory_x[1]), 	.s2_17_b(memory_h[2]),  .s11_18(mult_result[2]));
        s2_17_mult multer4 (  .s2_17_a(memory_x[2]), 	.s2_17_b(memory_h[3]),  .s11_18(mult_result[3]));
        s2_17_mult multer5 (  .s2_17_a(memory_x[3]), 	.s2_17_b(memory_h[4]),  .s11_18(mult_result[4]));
        s2_17_mult multer6 (  .s2_17_a(memory_x[4]), 	.s2_17_b(memory_h[5]),  .s11_18(mult_result[5]));
        s2_17_mult multer7 (  .s2_17_a(memory_x[5]), 	.s2_17_b(memory_h[6]),  .s11_18(mult_result[6]));
        s2_17_mult multer8 (  .s2_17_a(memory_x[6]), 	.s2_17_b(memory_h[7]),  .s11_18(mult_result[7]));
        s2_17_mult multer9(  .s2_17_a(memory_x[7]), 	.s2_17_b(memory_h[8]),  .s11_18(mult_result[8]));
        s2_17_mult multer10(  .s2_17_a(memory_x[8]), 	.s2_17_b(memory_h[9]),  .s11_18(mult_result[9]));
        s2_17_mult multer11(  .s2_17_a(memory_x[9]), 	.s2_17_b(memory_h[10]), .s11_18(mult_result[10]));
        s2_17_mult multer12( .s2_17_a(memory_x[10]), 	.s2_17_b(memory_h[11]), .s11_18(mult_result[11]));
        s2_17_mult multer13( .s2_17_a(memory_x[11]), 	.s2_17_b(memory_h[12]), .s11_18(mult_result[12]));
        s2_17_mult multer14( .s2_17_a(memory_x[12]), 	.s2_17_b(memory_h[13]), .s11_18(mult_result[13]));
        s2_17_mult multer15( .s2_17_a(memory_x[13]), 	.s2_17_b(memory_h[14]), .s11_18(mult_result[14]));
        s2_17_mult multer16( .s2_17_a(memory_x[14]), 	.s2_17_b(memory_h[15]), .s11_18(mult_result[15]));
        s2_17_mult multer17( .s2_17_a(memory_x[15]), 	.s2_17_b(memory_h[16]), .s11_18(mult_result[16]));
        s2_17_mult multer18( .s2_17_a(memory_x[16]), 	.s2_17_b(memory_h[17]), .s11_18(mult_result[17]));
        s2_17_mult multer19( .s2_17_a(memory_x[17]), 	.s2_17_b(memory_h[18]), .s11_18(mult_result[18]));
        s2_17_mult multer20( .s2_17_a(memory_x[18]), 	.s2_17_b(memory_h[19]), .s11_18(mult_result[19]));
        s2_17_mult multer21( .s2_17_a(memory_x[19]), 	.s2_17_b(memory_h[20]), .s11_18(mult_result[20]));
        s2_17_mult multer22( .s2_17_a(memory_x[20]), 	.s2_17_b(memory_h[21]), .s11_18(mult_result[21]));
        s2_17_mult multer23( .s2_17_a(memory_x[21]), 	.s2_17_b(memory_h[22]), .s11_18(mult_result[22]));
        s2_17_mult multer24( .s2_17_a(memory_x[22]), 	.s2_17_b(memory_h[23]), .s11_18(mult_result[23]));
        s2_17_mult multer25( .s2_17_a(memory_x[23]), 	.s2_17_b(memory_h[24]), .s11_18(mult_result[24]));
        s2_17_mult multer26( .s2_17_a(memory_x[24]), 	.s2_17_b(memory_h[25]), .s11_18(mult_result[25]));
        s2_17_mult multer27( .s2_17_a(memory_x[25]), 	.s2_17_b(memory_h[26]), .s11_18(mult_result[26]));
        s2_17_mult multer28( .s2_17_a(memory_x[26]), 	.s2_17_b(memory_h[27]), .s11_18(mult_result[27]));
        s2_17_mult multer29( .s2_17_a(memory_x[27]), 	.s2_17_b(memory_h[28]), .s11_18(mult_result[28]));
        s2_17_mult multer30( .s2_17_a(memory_x[28]), 	.s2_17_b(memory_h[29]), .s11_18(mult_result[29]));
        s2_17_mult multer31( .s2_17_a(memory_x[29]), 	.s2_17_b(memory_h[30]), .s11_18(mult_result[30]));
        s2_17_mult multer32( .s2_17_a(memory_x[30]), 	.s2_17_b(memory_h[31]), .s11_18(mult_result[31]));
        s2_17_mult multer33( .s2_17_a(memory_x[31]), 	.s2_17_b(memory_h[32]), .s11_18(mult_result[32]));
