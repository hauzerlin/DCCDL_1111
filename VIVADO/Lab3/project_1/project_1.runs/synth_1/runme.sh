...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v2.tcl
