...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source v2.tcl -notrace
