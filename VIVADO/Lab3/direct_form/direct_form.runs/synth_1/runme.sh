...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/direct_form/direct_form.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s2_15_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s2_15_mult.tcl
