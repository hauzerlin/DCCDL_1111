...
HD_PWD='D:/1111/DCCDL/VIVADO/Lab3/direct_form/direct_form.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s2_15_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s2_15_mult.tcl -notrace
