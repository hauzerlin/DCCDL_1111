...
HD_PWD='D:/1111/DCCL/VIVADO/Lab1/LFSR23/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_23.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LFSR_23.tcl
