...
HD_PWD='D:/1111/DCCL/VIVADO/Lab1/LFSR23/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LFSR_23.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LFSR_23.tcl -notrace
