...
HD_PWD='D:/1111/DCCL/VIVADO/Lab1/Gold_code/Gold_code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Gold_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Gold_top.tcl
