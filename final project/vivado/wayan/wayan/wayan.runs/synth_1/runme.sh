...
HD_PWD='D:/1111/DCCDL/final project/vivado/wayan/wayan/wayan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_SDF_Radix4_64point.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_SDF_Radix4_64point.tcl
