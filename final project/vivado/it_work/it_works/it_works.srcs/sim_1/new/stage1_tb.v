...
initial begin
	...
	real_mem[128] = 13'd128;
	real_mem[129] = 13'd28;
	real_mem[130] = -13'd157;
	real_mem[131] = 13'd296;

	real_mem[132] = 13'd148;
	real_mem[133] = -13'd52;
	real_mem[134] = -13'd231;
	real_mem[135] = 13'd243;

	real_mem[136] = -13'd166;
	real_mem[137] = 13'd280;
	real_mem[138] = 13'd229;
	real_mem[139] = -13'd344;

	real_mem[140] = -13'd159;
	real_mem[141] = 13'd192;
	real_mem[142] = -13'd180;
	real_mem[143] = -13'd167;

	real_mem[144] = -13'd128;
	real_mem[145] = 13'd39;
	real_mem[146] = 13'd293;
	real_mem[147] = -13'd80;

	real_mem[148] = -13'd40;
	real_mem[149] = -13'd40;
	real_mem[150] = -13'd14;
	real_mem[151] = 13'd141;

	real_mem[152] = 13'd181;
	real_mem[153] = 13'd175;
	real_mem[154] = -13'd89;
	real_mem[155] = -13'd51;

	real_mem[156] = 13'd99;
	real_mem[157] = -13'd122;
	real_mem[158] = 13'd330;
	real_mem[159] = 13'd69;

	real_mem[160] = 13'd0;
	real_mem[161] = 13'd342;
	real_mem[162] = 13'd104;
	real_mem[163] = -13'd12;

	real_mem[164] = -13'd186;
	real_mem[165] = -13'd38;
	real_mem[166] = -13'd31;
	real_mem[167] = -13'd85;

	real_mem[168] = -13'd347;
	real_mem[169] = 13'd246;
	real_mem[170] = 13'd441;
	real_mem[171] = 13'd393;

	real_mem[172] = -13'd61;
	real_mem[173] = -13'd58;
	real_mem[174] = 13'd530;
	real_mem[175] = -13'd224;

	real_mem[176] = 13'd0;
	real_mem[177] = -13'd253;
	real_mem[178] = -13'd167;
	real_mem[179] = -13'd383;

	real_mem[180] = -13'd179;
	real_mem[181] = 13'd147;
	real_mem[182] = -13'd12;
	real_mem[183] = 13'd331;

	real_mem[184] = -13'd182;
	real_mem[185] = -13'd348;
	real_mem[186] = -13'd147;
	real_mem[187] = 13'd689;

	real_mem[188] = -13'd138;
	...
	imag_mem[129] = -13'd15;
	imag_mem[130] = 13'd377;
	imag_mem[131] = 13'd369;

	imag_mem[132] = 13'd269;
	imag_mem[133] = 13'd261;
	imag_mem[134] = 13'd267;
	imag_mem[135] = -13'd196;

	imag_mem[136] = 13'd64;
	imag_mem[137] = 13'd124;
	imag_mem[138] = 13'd466;
	imag_mem[139] = -13'd50;

	imag_mem[140] = 13'd162;
	imag_mem[141] = -13'd38;
	imag_mem[142] = -13'd267;
	imag_mem[143] = 13'd338;

	imag_mem[144] = 13'd192;
	imag_mem[145] = 13'd66;
	imag_mem[146] = 13'd230;
	imag_mem[147] = -13'd219;

	imag_mem[148] = -13'd240;
	imag_mem[149] = 13'd311;
	imag_mem[150] = -13'd392;
	imag_mem[151] = -13'd325;

	imag_mem[152] = 13'd282;
	imag_mem[153] = 13'd135;
	imag_mem[154] = 13'd290;
	imag_mem[155] = 13'd41;

	imag_mem[156] = 13'd72;
	imag_mem[157] = 13'd113;
	imag_mem[158] = -13'd351;
	imag_mem[159] = 13'd193;

	imag_mem[160] = -13'd192;
	imag_mem[161] = -13'd329;
	imag_mem[162] = 13'd343;
	imag_mem[163] = 13'd648;

	imag_mem[164] = 13'd130;
	imag_mem[165] = -13'd335;
	imag_mem[166] = 13'd304;
	imag_mem[167] = -13'd234;

	imag_mem[168] = 13'd64;
	imag_mem[169] = -13'd217;
	imag_mem[170] = -13'd94;
	imag_mem[171] = -13'd194;

	imag_mem[172] = -13'd744;
	imag_mem[173] = 13'd229;
	imag_mem[174] = -13'd318;
	imag_mem[175] = -13'd115;

	imag_mem[176] = -13'd192;
	imag_mem[177] = -13'd322;
	imag_mem[178] = 13'd253;
	imag_mem[179] = 13'd329;

	imag_mem[180] = 13'd95;
	imag_mem[181] = 13'd221;
	imag_mem[182] = 13'd0;
	imag_mem[183] = -13'd122;

	imag_mem[184] = 13'd101;
	imag_mem[185] = -13'd170;
	imag_mem[186] = 13'd179;
	imag_mem[187] = -13'd204;

	imag_mem[188] = 13'd251;
	imag_mem[189] = -13'd43;
