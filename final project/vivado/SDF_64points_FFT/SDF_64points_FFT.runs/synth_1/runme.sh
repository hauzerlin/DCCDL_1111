...
HD_PWD='D:/1111/DCCDL/final project/vivado/SDF_64points_FFT/SDF_64points_FFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stage1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stage1.tcl
