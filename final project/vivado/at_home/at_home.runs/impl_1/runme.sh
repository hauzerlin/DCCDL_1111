...
HD_PWD='E:/1111/DCCDL/final project/vivado/at_home/at_home.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stage1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stage1.tcl -notrace
