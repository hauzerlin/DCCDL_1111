...
HD_PWD='D:/1111/DCCDL/final project/vivado/at_lab/at_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_two_stage_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_two_stage_top.tcl
