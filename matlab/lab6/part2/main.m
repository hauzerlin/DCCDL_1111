...
for cnt = 28:45
    [ control_stage4(cnt-27),C4_UO(cnt-27), C4_LO(cnt-27)] = commutator4(cnt, C4_UI(cnt-27), C4_LI(cnt-27));
end
...
M4 = B4_LO(1,1:16).*[ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2) ROM4(1,1:2)];
...
for cnt = 30:46
    [ control_stage5(cnt-29),C5_UO(cnt-29), C5_LO(cnt-29)] = commutator5(cnt, C5_UI(cnt-29), C5_LI(cnt-29));
end
